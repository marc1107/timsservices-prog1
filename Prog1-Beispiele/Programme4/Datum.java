...
public final class Datum {
    ...
    private Datum(/* final Datum this, */
                  final int tag, final int monat, final int jahr) {
        this.tag = tag;
        this.monat = monat;
        this.jahr = jahr;
    }
    ...
    public String toString(/* final Datum this */) {
        return String.format("%04d-%02d-%02d", this.jahr, this.monat, this.ta

    }

    @Override
    public boolean equals(/* final Datum this, */ final Object o) {
