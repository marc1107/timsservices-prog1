...
public final class DatumMitZeit { // Varianten 1, 2 und 3: extends Datum
     ...
     */
    public static DatumMitZeit valueOf(final int tag,
                                       final int monat,
                                       final int jahr,
                                       final int stunde,
                                       final int minute) {
    ...
    private DatumMitZeit(final int tag, final int monat, final int jahr,
                         final int stunde, final int minute) {
